...
import sty from "./PlasmicButton.module.css"; // plasmic-import: _eM8SB4QErat/css
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: sdsJonRhscg5/icon
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__m7And)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <RightArrowIcon
                className={classNames(projectcss.all, sty.svg__dBl2T)}
                role={"img"}
              />
            ),
